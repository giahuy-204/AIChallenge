...
area1 = [(417,229), (573,291), (522,311), (372,239)]
area2 = [(589,305), (886,422), (861,439), (558,323)]
...
while True:
    ...
    cv2.putText(frame, str(a1), (388,302), cv2.FONT_HERSHEY_PLAIN, 3, (255,255,255), 2)
    cv2.putText(frame, str(a2), (649,434), cv2.FONT_HERSHEY_PLAIN, 3, (255,255,255), 2)
